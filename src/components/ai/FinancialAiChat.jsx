...
import { MessageCircle, X, Send, Loader2, Copy, Sparkles } from "lucide-react";
...
const SHORTCUT_BUTTONS = [
  { label: "Cash flow", text: "Podsumuj cash flow i ryzyka z danych MIZAR." },
  { label: "Przeterminowane", text: "Ile faktur jest przeterminowanych i na jaką kwotę?" },
  { label: "Marże projektów", text: "Które projekty mają najniższą marżę, a które najwyższą? Odnieś się do danych JSON." },
              ...
              <div className="space-y-3 pr-2">
                {msgs.length === 0 && (
                  <p className="text-xs text-muted-foreground">
                    Zadaj pytanie o finanse MIZAR. Dane: fixture <code className="text-[10px]">mizar_data</code> + próbka
                    live z CRM.
                  </p>
                )}
                {msgs.map((m, i) => (
